...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Payment createPayment(String method, int total, Date transactionDate, CreditCard creditCard) {
        Payment payment = Payment.build(method, total, total, transactionDate, creditCard);
